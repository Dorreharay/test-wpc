      ...
      <div className={styles.menu} onClick={() => this.setState({ toggled: false }) }>
        <div className={styles.firstPart}>
          <div className={styles.choose}>
            <div className={styles.upperbox} onClick={this.handleClick}>
              <div>{projectName}</div>
              <svg className={toggled ? styles.firstPartIconOpen : styles.firstPartIconClosed}  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="255px" height="255px" viewBox="0 0 255 255" space="preserve">
          ...
          <div className={styles.spread}>
            <svg className={styles.spreadIcon} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        {projectName !== 'Виберіть проект' ? <div className={styles.secondPart}>
          <div className={styles.search}>
            <svg className={styles.secondPartIcon} version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <div onClick={this.handleEdit} className={editMode ? styles.editActive : styles.edit}>
            <svg className={styles.secondPartIcon} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 129 129">
              <g>
                <g>
